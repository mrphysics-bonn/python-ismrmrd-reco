...
A Python environment with all dependencies for running the scripts write_cartesian.py (2-echo GRE) & write_spiral.py (2D spiral GRE) can be installed by running `uv sync --extra seqdev` from the top directory.
